...
PayPal Express Checkout Payment Gateway for WooCommerce plugin lets you integrate PayPal Express checkout and/or PayPal Standard payment gateways in WooCommerce and lets you accept payment through PayPal’s secure payment gateway.

With this WooCommerce PayPal plugin, your customers can use their credit cards, debit cards, PayPal credit (Pay later), or PayPal money to make an order from the cart page itself. 

With PayPal Express checkout enabled you can ensure a smoother experience for your users as they never have to leave your website for making payments.
...
🔸 Tested OK with WooCommerce 5.6.0
...
##Pro version##
The following video explains the setup of the pro version of the plugin.
...
1. PayPal Express button-Cart page view
2. PayPal Express button-Checkout page view
3. Insert the PayPal credentials and enable the gateway
4. PayPal Express Checkout button settings
5. Show your store’s logo and header at the PayPal side-Branding.png
6. PayPal advanced options
