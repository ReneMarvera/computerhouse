...
ChatBot for WooCommerce. This simple and native WooCommerce ChatBot helps shoppers find products easily & increase sales! Supports Bargin ChatBot addon.

== Description ==
= What is ChatBot WoowBot? =
ChatBot for WooCommerce - WoowBot is a SIMPLE and Native WordPress ChatBot with zero configuration or bot training required. This plug n' play chatbot or conversational commerce shopbot does not require any 3rd party service integration. This is a simple ChatBot that lets your woocommerce shoppers search and find the right product quickly. If the shopper does not find the product they are searching for, they can email the shop admin directly from the ChatBot window.
